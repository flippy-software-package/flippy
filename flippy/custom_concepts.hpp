...
[[maybe_unused]] static Real operator""_r(long double value) { return static_cast<Real>(value); }
[[maybe_unused]] static Real operator""_r(unsigned long long value) { return static_cast<Real>(value); }
