...
template <fp::floating_point_number Real, fp::indexing_number Index> struct stlNode {
    Index      id;
    vec3<Real> pos;
...
template <fp::floating_point_number Real, fp::indexing_number Index> class stlTriangle {
    vec3<Real> normal_{};
