...
TEST_CASE("Proper topology change")
{
    ...
    SECTION("property test: common_neighbours and two_common_neighbours should give same results apart from ordering") {
        ...
        Triangulation<double, long> sphere(nodes, 0);
...
TEST_CASE("unittest private static functions")
{
    SECTION("unittest cot_between_vectors for a few vectors") {
        ...
        double cot_angle = Triangulation<double, int>::cot_between_vectors(li1, li2);
        ...
        double cot_angle30 = Triangulation<double, int>::cot_between_vectors(li1, li2);
        ...
        double cot_angle60 = Triangulation<double, int>::cot_between_vectors(li1, li2);
        ...
        double cot_angle45 = Triangulation<double, int>::cot_between_vectors(li1, li2);
